...
`;return e.$set=e=>{"size"in e&&n(0,r=e.size),"color"in e&&n(3,i=e.color)},[r,o,a,i]}class St extends R{constructor(e){super(),N(this,e,Et,At,s,{size:0,color:3})}}function _t(e,t,n){const r=e.slice();return r[5]=t[n],r}function Ft(e){let t;return{c(){t=d("div"),p(t,"class",e[2]),h(t,"animation-delay",100*e[5]+"ms"),h(t,"width",e[5]*(e[0]/6)+"px"),h(t,"height",e[5]*(e[0]/6)/2+"px")},m(e,n){a(e,t,n)},p(e,n){1&n&&h(t,"width",e[5]*(e[0]/6)+"px"),1&n&&h(t,"height",e[5]*(e[0]/6)/2+"px")},d(e){e&&l(t)}}}function Ot(t){let n,r=Ee(6,0),i=[];for(let e=0;e<r.length;e+=1)i[e]=Ft(_t(t,r,e));return{c(){n=d("div");for(let e=0;e<i.length;e+=1)i[e].c();p(n,"class",t[1])},m(e,t){a(e,n,t);for(let e=0;e<i.length;e+=1)i[e].m(n,null)},p(e,[t]){if(5&t){let s;for(r=Ee(6,0),s=0;s<r.length;s+=1){const o=_t(e,r,s);i[s]?i[s].p(o,t):(i[s]=Ft(o),i[s].c(),i[s].m(n,null))}for(;s<i.length;s+=1)i[s].d(1);i.length=r.length}},i:e,o:e,d(e){e&&l(n),c(i,e)}}}function jt(e,t,n){let{size:r}=t,{color:i}=t;const s=me`
  ...
  `;return e.$set=e=>{"size"in e&&n(3,r=e.size),"color"in e&&n(4,i=e.color)},[a,l,c,r,i]}class Tt extends R{constructor(e){super(),N(this,e,Lt,Rt,s,{size:3,color:4})}}function Gt(e){let t,n,r,i,s,c,h,g,m,v,$,b,x,w,y,k,z,C,A,E,S,I,N,R,L,T,G,q,M,P,W,B,Z,D,J,U,X,H,K,Q,V,ee,te,ne,re,ie,se,oe,ae,le,ce,de,ue,fe,pe,he,ge,me,ve,$e,be,we,ye,ze,Ce,Ee,Se,_e,Fe,Oe,Ye,Ie,Re,Le,Ge,qe,Pe,We,Be,Ze=e[0].default+"";const Je=new Me({props:{size:"60",color:"#FF3E00"}}),Ue=new ke({props:{size:"60px"}}),Xe=new je({props:{size:"60",color:"#FF3E00"}}),He=new xe({props:{size:"60",color:"#FF3E00"}}),Qe=new De({props:{size:"60",color:"#FF3E00"}}),Ve=new Ae({props:{size:"60px"}}),et=new Ke({props:{size:"60",color:"#FF3E00"}}),tt=new ft({props:{size:"60",color:"#FF3E00"}}),rt=new nt({props:{size:"60",color:"#FF3E00"}}),it=new Ne({props:{size:"60px"}}),st=new Te({props:{size:"60",color:"#FF3E00"}}),ot=new at({props:{size:"60",color:"#FF3E00"}}),lt=new gt({props:{size:"60",color:"#FF3E00"}}),ct=new xt({props:{size:"60",color:"#FF3E00"}}),dt=new kt({props:{size:"60",color:"#FF3E00"}}),ut=new St({props:{size:"60",color:"#FF3E00"}}),pt=new Yt({props:{size:"60",color:"#FF3E00"}}),ht=new Tt({props:{size:"60",color:"#FF3E00"}});return{c(){t=d("div"),n=d("h1"),r=u(Ze),i=f(),s=d("a"),s.textContent="Github",c=f(),h=d("section"),g=d("div"),O(Je.$$.fragment),m=f(),v=d("div"),v.textContent="SpinLine",$=f(),b=d("div"),O(Ue.$$.fragment),x=f(),w=d("div"),w.textContent="Circle2",y=f(),k=d("div"),O(Xe.$$.fragment),z=f(),C=d("div"),C.textContent="DoubleBounce",A=f(),E=d("div"),O(He.$$.fragment),S=f(),I=d("div"),I.textContent="Circle",N=f(),R=d("div"),O(Qe.$$.fragment),L=f(),T=d("div"),T.textContent="Stretch",G=f(),q=d("div"),O(Ve.$$.fragment),M=f(),P=d("div"),P.textContent="Circle3",W=f(),B=d("div"),O(et.$$.fragment),Z=f(),D=d("div"),D.textContent="BarLoader",J=f(),U=d("div"),O(tt.$$.fragment),X=f(),H=d("div"),H.textContent="SyncLoader",K=f(),Q=d("div"),O(rt.$$.fragment),V=f(),ee=d("div"),ee.textContent="Jumper",te=f(),ne=d("div"),O(it.$$.fragment),re=f(),ie=d("div"),ie.textContent="GoogleSpin",se=f(),oe=d("div"),O(st.$$.fragment),ae=f(),le=d("div"),le.textContent="ScaleOut",ce=f(),de=d("div"),O(ot.$$.fragment),ue=f(),fe=d("div"),fe.textContent="RingLoader",pe=f(),he=d("div"),O(lt.$$.fragment),ge=f(),me=d("div"),me.textContent="Rainbow",ve=f(),$e=d("div"),O(ct.$$.fragment),be=f(),we=d("div"),we.textContent="Wave",ye=f(),ze=d("div"),O(dt.$$.fragment),Ce=f(),Ee=d("div"),Ee.textContent="Firework",Se=f(),_e=d("div"),O(ut.$$.fragment),Fe=f(),Oe=d("div"),Oe.textContent="Pulse",Ye=f(),Ie=d("div"),O(pt.$$.fragment),Re=f(),Le=d("div"),Le.textContent="Jellyfish",Ge=f(),qe=d("div"),O(ht.$$.fragment),Pe=f(),We=d("div"),We.textContent="Chasing",p(n,"class","svelte-lait99"),p(s,"href","https://github.com/Schum123/svelte-loading-spinners"),p(s,"class","btn svelte-lait99"),p(t,"class","header svelte-lait99"),p(v,"class","spinner-title svelte-lait99"),p(g,"class","spinner-item svelte-lait99"),p(w,"class","spinner-title svelte-lait99"),p(b,"class","spinner-item svelte-lait99"),p(C,"class","spinner-title svelte-lait99"),p(k,"class","spinner-item svelte-lait99"),p(I,"class","spinner-title svelte-lait99"),p(E,"class","spinner-item svelte-lait99"),p(T,"class","spinner-title svelte-lait99"),p(R,"class","spinner-item svelte-lait99"),p(P,"class","spinner-title svelte-lait99"),p(q,"class","spinner-item svelte-lait99"),p(D,"class","spinner-title svelte-lait99"),p(B,"class","spinner-item svelte-lait99"),p(H,"class","spinner-title svelte-lait99"),p(U,"class","spinner-item svelte-lait99"),p(ee,"class","spinner-title svelte-lait99"),p(Q,"class","spinner-item svelte-lait99"),p(ie,"class","spinner-title svelte-lait99"),p(ne,"class","spinner-item svelte-lait99"),p(le,"class","spinner-title svelte-lait99"),p(oe,"class","spinner-item svelte-lait99"),p(fe,"class","spinner-title svelte-lait99"),p(de,"class","spinner-item svelte-lait99"),p(me,"class","spinner-title svelte-lait99"),p(he,"class","spinner-item svelte-lait99"),p(we,"class","spinner-title svelte-lait99"),p($e,"class","spinner-item svelte-lait99"),p(Ee,"class","spinner-title svelte-lait99"),p(ze,"class","spinner-item svelte-lait99"),p(Oe,"class","spinner-title svelte-lait99"),p(_e,"class","spinner-item svelte-lait99"),p(Le,"class","spinner-title svelte-lait99"),p(Ie,"class","spinner-item svelte-lait99"),p(We,"class","spinner-title svelte-lait99"),p(qe,"class","spinner-item svelte-lait99"),p(h,"class","svelte-lait99")},m(e,l){a(e,t,l),o(t,n),o(n,r),o(t,i),o(t,s),a(e,c,l),a(e,h,l),o(h,g),j(Je,g,null),o(g,m),o(g,v),o(h,$),o(h,b),j(Ue,b,null),o(b,x),o(b,w),o(h,y),o(h,k),j(Xe,k,null),o(k,z),o(k,C),o(h,A),o(h,E),j(He,E,null),o(E,S),o(E,I),o(h,N),o(h,R),j(Qe,R,null),o(R,L),o(R,T),o(h,G),o(h,q),j(Ve,q,null),o(q,M),o(q,P),o(h,W),o(h,B),j(et,B,null),o(B,Z),o(B,D),o(h,J),o(h,U),j(tt,U,null),o(U,X),o(U,H),o(h,K),o(h,Q),j(rt,Q,null),o(Q,V),o(Q,ee),o(h,te),o(h,ne),j(it,ne,null),o(ne,re),o(ne,ie),o(h,se),o(h,oe),j(st,oe,null),o(oe,ae),o(oe,le),o(h,ce),o(h,de),j(ot,de,null),o(de,ue),o(de,fe),o(h,pe),o(h,he),j(lt,he,null),o(he,ge),o(he,me),o(h,ve),o(h,$e),j(ct,$e,null),o($e,be),o($e,we),o(h,ye),o(h,ze),j(dt,ze,null),o(ze,Ce),o(ze,Ee),o(h,Se),o(h,_e),j(ut,_e,null),o(_e,Fe),o(_e,Oe),o(h,Ye),o(h,Ie),j(pt,Ie,null),o(Ie,Re),o(Ie,Le),o(h,Ge),o(h,qe),j(ht,qe,null),o(qe,Pe),o(qe,We),Be=!0},p(e,[t]){(!Be||1&t)&&Ze!==(Ze=e[0].default+"")&&function(e,t){t=""+t,e.data!==t&&(e.data=t)}(r,Ze)},i(e){Be||(_(Je.$$.fragment,e),_(Ue.$$.fragment,e),_(Xe.$$.fragment,e),_(He.$$.fragment,e),_(Qe.$$.fragment,e),_(Ve.$$.fragment,e),_(et.$$.fragment,e),_(tt.$$.fragment,e),_(rt.$$.fragment,e),_(it.$$.fragment,e),_(st.$$.fragment,e),_(ot.$$.fragment,e),_(lt.$$.fragment,e),_(ct.$$.fragment,e),_(dt.$$.fragment,e),_(ut.$$.fragment,e),_(pt.$$.fragment,e),_(ht.$$.fragment,e),Be=!0)},o(e){F(Je.$$.fragment,e),F(Ue.$$.fragment,e),F(Xe.$$.fragment,e),F(He.$$.fragment,e),F(Qe.$$.fragment,e),F(Ve.$$.fragment,e),F(et.$$.fragment,e),F(tt.$$.fragment,e),F(rt.$$.fragment,e),F(it.$$.fragment,e),F(st.$$.fragment,e),F(ot.$$.fragment,e),F(lt.$$.fragment,e),F(ct.$$.fragment,e),F(dt.$$.fragment,e),F(ut.$$.fragment,e),F(pt.$$.fragment,e),F(ht.$$.fragment,e),Be=!1},d(e){e&&l(t),e&&l(c),e&&l(h),Y(Je),Y(Ue),Y(Xe),Y(He),Y(Qe),Y(Ve),Y(et),Y(tt),Y(rt),Y(it),Y(st),Y(ot),Y(lt),Y(ct),Y(dt),Y(ut),Y(pt),Y(ht)}}}function qt(e,t,n){let{name:r}=t;return e.$set=e=>{"name"in e&&n(0,r=e.name)},[r]}return new class extends R{constructor(e){super(),N(this,e,qt,Gt,s,{name:0})}}({target:document.body,props:{name:{default:"svelte-loading-spinners"}}})}();
